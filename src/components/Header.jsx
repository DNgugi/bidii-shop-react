...
function Header() {
  ...
  return (
    <header className="fixed z-20 top-0 right-0 left-0 grid grid-cols-12 items-center bg-mainGold px-4 h-20">
      ...
      <div id="main-nav" className="hidden fixed left-0 top-20 md:top-0 h-screen bg-mainGold w-96 md:w-full md:inline md:relative md:h-auto md:col-span-6">{<Nav />}</div>
